...
// `og/` holds the 1200×630 social-preview JPEGs the prerender step links from
// <meta property="og:image">, not from any page body, so it is not audited here.
const files = readdirSync('public/media').filter((f) => !f.startsWith('.') && f !== 'og')
